...
for å kunne gjøre nettsidene bærbare slik at python skolen kan 
...
Navigering utenom tema i python skolen er definert i top menyen.
På høyre side er en meny som viser status på brukerens progresjon i kurset,
samt en lenke til en side han/hun kan se troféer som er oppnådd. 
...
Alle html filer ligger i en undermappe slik at det er lettere å vedlikeholde menyene
generert av javascript filene. 
index.html i rootmappen inneholder bare en fast forward til
main/index.html som er den egentlige index siden. 
...
styling på formateringen gjort av python.js
...
XML
---
Xml fil ligger i trophies mappen. Denne brukes for å beskrive titler som 
brukeren av siden kan få, og poengsum som trengs for å oppnå dem.
